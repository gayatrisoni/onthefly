...
const createDestinatonsTable = async () => {
    const createDestinatonsTableQuery = `
    ...
    `
    try {
        const res = await pool.query(createDestinatonsTableQuery)
...
const createTripsDestinationsTable = async () => {
    ...
    try {
        ...
        console.log('trips_destinations table create successfully')

    } catch (err) {
        console.error('error creating trips_destinationa table', err)
    }
}
...
const createTripsUsersTable = async () => {
    ...
    try {
        ...
        console.log('trips_users table create successfully')
    } catch (err) {
        console.error('error creating trips_users table', err)
    }
}

createDestinatonsTable()
